    ...
    <div className="container font w-100">
      ...
      <div className="p-5">
        ...
        <p>
          ...
          Technology (ISTT) Mirpur in Dhaka. In the time, I Completed Programing
          Hero Online course with sir Jhankar Mahbub and worked at many
          Applications,Projects and other things. Aside from work, I am also an
          ...
          large-scale distributed MERN Stack developing systems.
        </p>
        <Row>
          <Col xs={12} md={8} lg={6}>
            <h4>Interests</h4>
